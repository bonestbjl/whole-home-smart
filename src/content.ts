...
export const image = (id: string) =>
  `https://images.unsplash.com/${id}?auto=format&fit=crop&w=1800&q=84`
...
export const dayMoments: DayMoment[] = [
  ...
  },
  {
    time: '08:10',
    title: '离家',
    image: image('photo-1600607687644-c7171b42498b'),
    tone: 'away',
  ...
  },
  {
    time: '23:50',
    title: '睡眠',
    image: image('photo-1604014237800-1c9102c219da'),
    tone: 'night',
...
export const labScenes = [
  { title: '观影模式', image: image('photo-1618220179428-22790b461013'), action: '按下观影', steps: ['客厅主灯渐暗', '窗帘关闭', '投影与音响启动', '手机减少打扰'] },
  { title: '睡眠模式', image: image('photo-1617325247661-675ab4b64ae2'), action: '一句晚安', steps: ['全屋灯光熄灭', '主卧温度进入睡眠曲线', '夜间地脚灯待命', '安防转入夜间守护'] },
  { title: '离家模式', image: image('photo-1600607687920-4e2a09cf159d'), action: '门锁上锁', steps: ['灯光全部关闭', '空调节能运行', '窗帘进入隐私状态', '门窗传感布防'] },
  { title: '长辈守护', image: image('photo-1513694203232-719a280e022f'), action: '夜间起身', steps: ['床边灯轻亮', '走廊地脚灯联动', '燃气与门锁复核', '异常静止提醒'] },
]

export const solutionSystems: SolutionSystem[] = [
  { title: '智能照明', problem: '开关分散、夜间刺眼、灯光氛围单一。', solution: '通过分区调光、人体感应和场景预设，让光线跟随时间与活动变化。', scenes: '回家、起夜、观影、会客、儿童睡眠。', family: '重视氛围、老人儿童夜间通行、无主灯设计家庭。', devices: '调光模块、智能开关、人体传感、场景面板。', image: image('photo-1600566753190-17f0baa2a6c3') },
  { title: '智能遮阳', problem: '忘记拉窗帘、隐私和采光需要反复手动调整。', solution: '根据时间、日照、观影和离家状态自动开合窗帘。', scenes: '清晨唤醒、午后遮阳、观影、离家隐私。', family: '大窗景住宅、客厅阳台、卧室舒适需求强的家庭。', devices: '窗帘电机、轨道、光照传感、场景面板。', image: image('photo-1600607687939-ce8a6c25118c') },
  { title: '智能安防', problem: '离家后担心门锁、燃气、门窗和老人儿童状态。', solution: '门锁、门窗、燃气、烟感和摄像能力联动，异常状态及时提醒。', scenes: '离家布防、夜间守护、燃气提醒、孩子到家通知。', family: '有老人儿童、经常出差、关注安全边界的家庭。', devices: '智能门锁、门窗传感、烟感、燃气传感、摄像设备。', image: image('photo-1558002038-1055907df827') },
  { title: '智能温控', problem: '空调反复调节、不同房间舒适度不一致。', solution: '结合时间、房间状态和家庭习惯，形成舒适节能的温度曲线。', scenes: '回家预冷、睡眠温控、离家节能、老人房恒温。', family: '重视舒适和节能、房间多、老人儿童敏感家庭。', devices: '空调控制器、温湿度传感、地暖控制、新风联动。', image: image('photo-1600585154340-be6161a56a0c') },
  { title: '智能环境', problem: '空气、湿度和异味变化不易被及时察觉。', solution: '持续监测空气质量，并联动新风、空调或提醒开窗。', scenes: '儿童房空气、烹饪排风、睡眠环境、宠物无人环境。', family: '有儿童、宠物、老人或空气敏感成员的家庭。', devices: '空气传感、温湿度传感、新风控制、净化设备联动。', image: image('photo-1600607688969-a5bfcd646154') },
  { title: '智能影音', problem: '观影前设备多、操作分散、氛围难统一。', solution: '把灯光、窗帘、投影、音响和免打扰状态整合为一个场景。', scenes: '观影、游戏、家庭影院、周末娱乐。', family: '喜欢影音娱乐、客厅影院或独立影音室家庭。', devices: '投影联动、音响控制、灯光场景、窗帘控制。', image: image('photo-1621293954908-907159247fc8') },
  { title: '智能中控', problem: '设备越多越难用，家人不愿学习复杂 App。', solution: '把复杂设备收束到场景面板、语音和自动化规则中。', scenes: '一键回家、离家、晚安、会客、清洁。', family: '全屋系统较完整、多人共同使用、重视稳定交付的家庭。', devices: '中控主机、场景面板、语音网关、自动化规则。', image: image('photo-1558002038-1055907df827') },
]
